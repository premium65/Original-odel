...
import ratingBg from "@assets/rating-bg.png";
...
export default function AdsPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative" style={{ backgroundImage: `url(${ratingBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      {/* Dark overlay */}
